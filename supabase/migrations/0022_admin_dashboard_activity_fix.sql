...
-- Migration 0022
-- Admin Dashboard 4.0 activity-source fix
-- ============================================================
-- The platform does not have public.learning_activity.
-- Use question_attempts, which is the existing persistent
-- learning activity table, for dashboard activity metrics.
...
begin
  ...
  select jsonb_build_object(
    ...
    'learning', jsonb_build_object(
      ...
      'average_streak', (
        select coalesce(round(avg(current_streak)), 0)
        from public.profiles
      )
    ),
    'recent_activity', (
...
select to_regprocedure(
  'public.get_admin_dashboard_analytics()'
) as get_admin_dashboard_analytics;
