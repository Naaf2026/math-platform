...
select 'g3-v2-pv-'||g,'place-value','What number is shown in the place-value house?',
 ...
 'Read each place-value column from left to right.','Mathematics','published',array['grade3','visual','place-value'],'Grade 3'
...
select 'g3-v2-ab-'||g,'number-line-and-abacus','Which number does this abacus represent?',
 ...
 'Each column represents a different place value.','Mathematics','published',array['grade3','visual','abacus'],'Grade 3'
...
select 'g3-v2-pat-'||g,'skip-counting','What number comes next in the visual pattern?',
 ...
 'Look at how much each card increases.','Mathematics','published',array['grade3','visual','counting'],'Grade 3'
...
select 'g3-v2-r10-'||g,'estimation','Use the number line. What is '||n||' rounded to the nearest ten?',
 ...
 'Compare the distance to the two endpoints.','Mathematics','published',array['grade3','visual','rounding'],'Grade 3'
...
select 'g3-v2-r100-'||g,'estimation','Use the number line. What is '||n||' rounded to the nearest hundred?',
 ...
 jsonb_build_object('visual',jsonb_build_object('kind','rounding_number_line','lower',lo,'value',n,'upper',hi)),
 'Compare the distance to the two hundreds.','Mathematics','published',array['grade3','visual','rounding'],'Grade 3'
...
select 'g3-v2-add-'||g,'addition-subtraction','Use the H-T-O columns to find the sum.',
 ...
 'Line up hundreds, tens and ones before adding.','Mathematics','published',array['grade3','visual','addition'],'Grade 3'
...
select 'g3-v2-sub-'||g,'addition-subtraction','Use the H-T-O columns to find the difference.',
 ...
 'Work through ones, tens and hundreds.','Mathematics','published',array['grade3','visual','subtraction'],'Grade 3'
...
select 'g3-v2-mtn-'||g,'addition-subtraction','Look at the mountain diagram. Which peak is tallest?',
 ...
 'Find the greatest height, then choose its peak label.','Mathematics','published',array['grade3','visual','comparison'],'Grade 3'
from (
