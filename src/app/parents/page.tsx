...
const faqs = [
  ...
  ["How do I start?","Choose Start Learning to sign in or register. You can review the available trial and subscription options during registration."],
    ...
    <header className="sticky top-0 z-50 border-b border-[#d9ecf8] bg-white/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-5 py-3">
        ...
        <nav className="flex flex-wrap items-center gap-3 text-sm font-extrabold sm:gap-5">
          ...
          <Link href="/login" className="rounded-xl bg-[#ff6b22] px-4 py-3 text-white">Start Learning</Link>
        </nav>
      </div>
    </header>
    <section className="relative overflow-hidden bg-[#ddf3ff]">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-8 px-6 py-14 md:grid-cols-2 md:py-24">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-3"><Link href="/login" className="inline-flex items-center gap-2 rounded-2xl bg-[#ff6b22] px-7 py-4 font-black text-white shadow-lg shadow-orange-200">Start Learning <ArrowRight size={19}/></Link><a href="#try-it" className="rounded-2xl border-2 border-[#168fe1] bg-white px-7 py-4 font-black text-[#07528e]">Try a Sample Question</a></div>
