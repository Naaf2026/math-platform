...
export default function AdminBooksPage(){
 ...
 const[status,setStatus]=useState("Loading book library…"),[notice,setNotice]=useState(""),[showForm,setShowForm]=useState(false),[busy,setBusy]=useState(false),[processingId,setProcessingId]=useState<string|null>(null),[templateId,setTemplateId]=useState<string|null>(null),[file,setFile]=useState<File|null>(null);
