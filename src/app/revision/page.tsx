...
export default function RevisionPage() {
  ...
  function submitRevision(){if(!allAnswered)return;setChecked(Object.fromEntries(questions.map(q=>[q.id,true])));setShowResults(true);}
