...
type RevisionQuestion = { id:string; prompt:string; answer:string; explanation?:string|null; skill?:string|null; topic?:string|null; topic_id?:string|null; question_type?:string|null; options?:string[]|null; from_mistake?:boolean; };
