    ...
    <main className="min-h-screen bg-white text-[#16345b]">
      ...
      <div className="mx-auto max-w-4xl px-5 pb-20 pt-12 sm:pt-16">
        ...
        <section className="mx-auto mt-12 max-w-xl rounded-3xl border border-slate-200 bg-white px-6 py-10 text-center shadow-[0_8px_35px_rgba(25,65,105,0.07)] sm:px-10">
          ...
          <Link href="/subscription" className="mt-7 inline-flex w-full items-center justify-center rounded-full bg-[#f49c20] px-8 py-4 text-lg font-extrabold text-white transition hover:bg-[#db8410] sm:w-auto sm:min-w-56">Try Now</Link>
        </section>
        ...
        <div className="mt-12 text-center"><Link href="/subscription" className="inline-flex items-center justify-center rounded-full bg-[#f49c20] px-9 py-4 font-extrabold text-white hover:bg-[#db8410]">Start Your Free 3-Day Trial</Link></div>
      </div>
    </main>
  );
}
