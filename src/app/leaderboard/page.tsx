...
type Learner = { id: string; full_name: string | null; xp: number; current_streak: number };
...
export default function LeaderboardPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      const { data } = await supabase.from("profiles").select("id,full_name,xp,current_streak").order("xp", { ascending: false }).limit(50);
