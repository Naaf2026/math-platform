...
export default function LeaderboardPage(){
 ...
 <section className="overflow-hidden rounded-[28px] bg-[#4ac3ed] shadow-lg"><img src="/leaderboard-assets/leaderboard-hero.webp" alt="Leaderboard: celebrate your progress with other learners" className="block h-auto w-full object-cover" /></section>
