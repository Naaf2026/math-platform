...
export default function PrivacyPage(){
 return <main className="min-h-screen bg-[#eef9ff] text-[#12204a]">
  ...
  <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-12">
   <section className="rounded-[2rem] bg-[#073b73] p-7 text-white shadow-xl sm:p-10"><div className="flex items-center gap-4"><span className="grid h-14 w-14 place-items-center rounded-2xl bg-white/10 text-cyan-200"><ShieldCheck size={30}/></span><div><p className="text-xs font-black uppercase tracking-[.18em] text-cyan-200">Fahi Hisaabu</p><h1 className="mt-1 text-3xl font-black sm:text-4xl">Privacy Policy</h1></div></div><p className="mt-5 max-w-2xl font-semibold leading-7 text-blue-100">This page explains how information is handled when learners use the Fahi Hisaabu maths learning platform.</p><p className="mt-3 text-sm font-bold text-blue-200">Draft for pre-launch review • Updated September 2026</p></section>
