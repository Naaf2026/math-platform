...
export default function VisualQuestionsPage(){
 ...
 return <main className="relative h-[100dvh] overflow-hidden bg-[#eef9ff] text-[#083d78]">{celebration&&rewardToast&&<div className="pointer-events-none fixed inset-0 z-[100] flex items-center justify-center overflow-hidden bg-sky-50/25 backdrop-blur-[1px]">
