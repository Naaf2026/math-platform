...
export default function VisualQuestionsPage(){
 ...
 return <main className="min-h-screen bg-[#eef9ff] pb-24 text-[#083d78] lg:pb-0">
  <header className="sticky top-0 z-30 border-b border-[#dcecf6] bg-white/95 backdrop-blur"><div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 sm:px-6"><Link href="/dashboard" className="grid h-10 w-10 shrink-0 place-items-center rounded-2xl bg-[#eef6fc] text-[#197fe9]"><ArrowLeft size={18}/></Link><div className="min-w-0 lg:w-[280px] lg:shrink-0"><p className="text-[10px] font-black uppercase tracking-[.2em] text-[#197fe9]">Premium • Visual Maths</p><h1 className="truncate text-base font-black sm:text-lg">See it. Think it. Solve it. 👀</h1></div><nav className="hidden min-w-0 flex-1 items-center justify-center gap-1 xl:gap-3 lg:flex" aria-label="Student navigation desktop"><Link href="/dashboard" className="flex items-center gap-2 rounded-xl px-2.5 py-2 font-black hover:bg-sky-50"><Home size={21}/>Home</Link><Link href="/brain-games" className="flex items-center gap-2 rounded-xl px-2.5 py-2 font-black hover:bg-sky-50"><Gamepad2 size={21}/>Games</Link><Link href="/leaderboard" className="flex items-center gap-2 rounded-xl px-2.5 py-2 font-black hover:bg-sky-50"><Trophy size={21}/>Leaderboard</Link><Link href="/rewards" className="flex items-center gap-2 rounded-xl px-2.5 py-2 font-black hover:bg-sky-50"><Gift size={21}/>Rewards</Link><Link href="/progress" className="flex items-center gap-2 rounded-xl px-2.5 py-2 font-black hover:bg-sky-50"><BarChart3 size={21}/>Progress</Link><Link href="/profile" className="flex items-center gap-2 rounded-xl px-2.5 py-2 font-black hover:bg-sky-50"><GraduationCap size={21}/>Profile</Link></nav><div className="ml-auto shrink-0 rounded-2xl bg-[#fff4cf] px-3 py-2 text-xs font-black text-[#806a12]"><Crown size={14} className="mr-1 inline"/> {access.plan_name}</div></div></header>
