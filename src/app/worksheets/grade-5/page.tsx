...
return <main className={embedded?"bg-[#f8f5e9] text-[#17234b] print:bg-white":"min-h-screen bg-[#f8f5e9] text-[#17234b] print:bg-white"}>
 ...
 <div className="mb-4 flex justify-end gap-2 print:hidden"><Link href="/worksheets/grade-4" className="rounded-xl border border-violet-200 bg-white px-4 py-2 text-sm font-black text-violet-700">Grade 4 Worksheets →</Link></div><header className="mb-5 print:hidden"><h1 className="text-3xl font-black">Grade 5 Worksheets</h1><p className="text-sm font-medium">Grade 5 mathematics practice.</p></header>
