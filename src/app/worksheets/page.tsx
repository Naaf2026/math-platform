...
export default function WorksheetsPage(){
 ...
 return <main className="min-h-screen bg-[#f8f5e9] text-[#17234b] print:bg-white"><div className="mx-auto max-w-5xl px-3 py-5 sm:px-6 print:max-w-none print:p-0">
  ...
  <section className="mt-5 print:mt-0">
   ...
   <div className="mt-5 space-y-4">{problems.map((p,i)=>{const expected=answerFor(p,operation),correct=(answers[i]??"")===expected;return <div key={i} className="grid items-center gap-4 rounded-2xl border-2 border-[#cde6e3] bg-white p-4 sm:grid-cols-[auto_1fr_auto] print:break-inside-avoid">\n    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-violet-100 text-base font-black text-violet-700 print:border print:border-slate-400 print:bg-white print:text-black">{i+1}</div>\n    <div className="flex min-w-0 flex-wrap items-center gap-3">
