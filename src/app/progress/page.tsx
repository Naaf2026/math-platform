...
export default function ProgressPage(){
 ...
 <section className="mt-3 h-[140px] overflow-hidden rounded-[22px] bg-[#dff5ff] sm:h-[190px] lg:h-[230px]"><img src="/progress-assets/progress-hero.webp" alt="My Progress — See how much you have learned and keep going!" className="block h-full w-full object-fill" onError={e=>{e.currentTarget.style.display="none";}}/></section>
