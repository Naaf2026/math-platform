...
export default function ProgressPage(){
 ...
 <section className="mt-3 h-[140px] overflow-hidden rounded-[22px] bg-gradient-to-r from-[#27b4f4] to-[#86dfff] sm:h-[190px] lg:h-[230px]"><img src="/progress-assets/progress-hero.webp" alt="My Progress — See how much you've learned and keep going!" className="block h-full w-full object-cover object-center" onError={e=>{e.currentTarget.style.display="none";e.currentTarget.parentElement?.classList.add("min-h-[180px]");}}/></section>
