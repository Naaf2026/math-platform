...
export default function ProgressPage(){
 ...
 return <main className="min-h-screen overflow-x-hidden bg-[#eef9ff] text-[#083d78]">
  ...
  <div className="mx-auto flex max-w-[1680px]"><section className="min-w-0 flex-1 px-4 py-6 pb-24 sm:px-6 lg:px-12 lg:py-10"><div className="mx-auto max-w-[1340px]"><div className="mb-7"><p className="text-sm font-black uppercase tracking-[.18em] text-[#197fe9]">Learning Progress</p><h1 className="mt-1 text-[38px] font-black sm:text-[48px] lg:text-[54px]">Your Progress 📈</h1><p className="mt-2 text-[18px] font-semibold text-[#6685a4] sm:text-[21px]">See how your maths skills are growing.</p></div>
   ...
   <section className="mt-7 overflow-hidden rounded-[2rem] bg-gradient-to-br from-violet-600 via-indigo-600 to-blue-500 p-7 text-white shadow-2xl sm:p-10">
    <div className="grid gap-8 lg:grid-cols-[1.2fr_.8fr] lg:items-center">
     <div><div className="inline-flex items-center gap-2 rounded-full bg-white/15 px-3 py-1.5 text-xs font-black uppercase tracking-wider"><BarChart3 size={14}/> Learning intelligence</div><h1 className="mt-4 text-4xl font-black sm:text-5xl">See how you are <span className="text-yellow-300">growing</span> 🚀</h1><p className="mt-3 max-w-xl text-indigo-100">Track mastery, accuracy, weekly activity, strengths and the next skill to work on.</p><div className="mt-6 flex flex-wrap gap-3"><Link href="/challenge" className="rounded-2xl bg-yellow-300 px-5 py-3 font-black text-[#071b3a] shadow-lg">Practise now 🎯</Link><Link href="/rewards" className="rounded-2xl bg-white/15 px-5 py-3 font-black text-white ring-1 ring-white/20">View rewards 🏆</Link></div></div>
