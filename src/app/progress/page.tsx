...
export default function ProgressPage(){
 ...
 <section className="relative mt-3 h-[140px] overflow-hidden rounded-[22px] bg-[#dff5ff] sm:h-[190px] lg:h-[230px]"><div className="absolute inset-0 flex flex-col justify-center px-6 text-[#123c7a]"><h1 className="text-2xl font-black sm:text-4xl">My Progress</h1><p className="mt-2 text-sm font-bold sm:text-lg">See how much you have learned and keep going!</p></div><img src="/progress-assets/progress-hero.webp" alt="My Progress — See how much you have learned and keep going!" className="relative block h-full w-full object-fill" onError={e=>{e.currentTarget.style.display="none";}}/></section>
