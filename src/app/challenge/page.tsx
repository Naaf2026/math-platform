...
export default function Challenge() {
  ...
  async function submitAnswer(answer = draft) {
    ...
    const normalizedAnswer = isVisual ? visualSubmittedAnswer() : isOrdering ? orderedIds.join(",") : answer.trim();
    ...
    if (isVisual) localCorrect = visualIsCorrect();
  ...
  const correctAnswerText = isVisual
