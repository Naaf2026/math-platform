...
export default function Challenge() {
  ...
  function resetQuestion(nextIndex: number) {
    setIndex(nextIndex);
    setDraft(""); setSubmitted(false); setResultCorrect(null); setBuilt(0); setError("");
  }
  ...
  async function submitAnswer(answer = draft) {
    ...
    setDraft(answer.trim()); setResultCorrect(isCorrect); setSubmitted(true);
  ...
  const correctAnswerText = correctOption?.text || current.answer;
