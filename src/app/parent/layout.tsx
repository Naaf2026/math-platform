    ...
    <>
      <nav className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/90 px-4 py-3 shadow-sm backdrop-blur sm:px-6">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3">
          <Link href="/parent" className="font-black tracking-tight text-[#071b3a]">
            Family Learning Centre
          </Link>
          <div className="flex flex-wrap items-center gap-2 text-sm font-black">
            <Link href="/parent" className="inline-flex items-center gap-2 rounded-full px-3 py-2 text-slate-600 transition hover:bg-slate-100 hover:text-[#071b3a]">
              <LayoutDashboard size={16} /> Overview
            </Link>
            <Link href="/parent/learners" className="inline-flex items-center gap-2 rounded-full bg-violet-50 px-3 py-2 text-violet-700 transition hover:bg-violet-100">
              <Users size={16} /> Your Learners
            </Link>
            <Link href="/parent/goals" className="inline-flex items-center gap-2 rounded-full px-3 py-2 text-slate-600 transition hover:bg-slate-100 hover:text-[#071b3a]">
              <Target size={16} /> Goals
            </Link>
            <Link href="/parent/notifications" className="inline-flex items-center gap-2 rounded-full px-3 py-2 text-slate-600 transition hover:bg-slate-100 hover:text-[#071b3a]">
              <Bell size={16} /> Alerts
            </Link>
          </div>
        </div>
