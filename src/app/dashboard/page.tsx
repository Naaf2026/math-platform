        ...
        <section className="min-w-0 flex-1 px-4 py-6 sm:px-6 sm:py-8 lg:px-12 xl:px-14">
          <div className="mx-auto max-w-[1340px]">
            <div className="mb-5 rounded-[24px] border border-[#d7eaf7] bg-white/85 p-4 shadow-sm lg:hidden sm:p-5">
              ...
              <div className="mt-4 grid grid-cols-3 gap-2 border-t border-[#dcecf6] pt-4 sm:gap-3"><div className="rounded-2xl bg-[#fff6df] px-2 py-2 text-center"><div className="text-xl">🔥</div><p className="mt-0.5 text-[12px] font-black sm:text-[13px]">{profile?.current_streak ?? 0} Day Streak</p></div><div className="rounded-2xl bg-[#fff8d9] px-2 py-2 text-center"><div className="text-xl">⭐</div><p className="mt-0.5 text-[12px] font-black sm:text-[13px]">{profile?.xp ?? 0} XP</p></div><div className="rounded-2xl bg-[#eef8ff] px-2 py-2 text-center"><div className="text-xl">🏅</div><p className="mt-0.5 text-[12px] font-black sm:text-[13px]">12 Badges</p></div></div>
            </div>

            <div className="mb-5 grid grid-cols-2 gap-2.5 lg:hidden"><div className="flex items-center justify-between rounded-xl border border-[#e8d37a] bg-[#fff8d9] px-3 py-2 shadow-sm"><span className="text-[11px] font-black text-[#806a12]">Mind Sparks</span><span className="text-sm font-black">✨ {mind.balance}</span></div><div className="flex items-center justify-between rounded-xl border border-[#9bd8f5] bg-[#e9f8ff] px-3 py-2 shadow-sm"><span className="text-[11px] font-black text-[#17618a]">Mind Time</span><span className="text-sm font-black">⏱️ {formatMindTime(mind.remaining_seconds)}</span></div></div>
