...
export default function DashboardPage() {
  ...
  <button type="button" onClick={() => { if (isPremium) setShowVisualStart(true); else setShowVisualPremium(true); }} className="order-2 group relative h-auto min-h-[420px] overflow-hidden rounded-[32px] border-2 border-[#9b8cff] bg-[#f0edff] text-left shadow-lg transition hover:-translate-y-1 hover:shadow-2xl xl:col-start-1 xl:row-start-2 md:h-[clamp(410px,calc(100dvh-230px),500px)] md:min-h-0">
    ...
    <div className="absolute left-6 right-6 top-[43%] bottom-0 rounded-t-[70px] bg-white px-2 pt-6 sm:pt-7">
      <div className="flex items-start justify-between gap-3">
        <h2 className="min-w-0 pr-1 text-[30px] font-black leading-[0.95] text-[#183b68] sm:text-[34px]">Visual<br />Math Lab</h2>
      ...
      <p className="mt-3 text-[15px] font-bold text-[#55708b]">👀 &nbsp;See, explore and solve maths visually</p>
      <div className="absolute bottom-4 left-2 right-2 rounded-full bg-[#735fe6] px-5 py-3 text-center text-[18px] font-black text-white shadow-md">Start →</div>
    </div>
  </button>

  <Link href="/homework" className="order-3 group relative h-auto min-h-[420px] overflow-hidden rounded-[32px] border-2 border-[#66b8f2] bg-[#e7f5ff] text-left shadow-lg transition hover:-translate-y-1 hover:shadow-2xl xl:col-start-2 xl:row-start-1 md:h-[clamp(410px,calc(100dvh-230px),500px)] md:min-h-0">
    <div className="absolute inset-x-0 top-0 flex h-[46%] items-center justify-center overflow-hidden rounded-t-[30px] bg-gradient-to-br from-[#9ad8ff] via-[#c3eaff] to-[#e2f6ff]" aria-hidden="true">
      ...
      <span className="relative text-[clamp(80px,11vw,125px)] drop-shadow-xl transition duration-300 group-hover:scale-105">📚</span>
    </div>
    <div className="absolute bottom-0 left-6 right-6 top-[43%] rounded-t-[70px] bg-[#f5fbff] px-2 pt-6 sm:pt-7">
      <h2 className="text-[30px] font-black leading-[0.95] text-[#183b68] sm:text-[34px]">My<br />Homework</h2>
      <p className="mt-3 text-[15px] font-bold text-[#55708b]">Your maths homework and practice worksheets</p>
      <div className="absolute bottom-4 left-2 right-2 rounded-full bg-[#197fe9] px-5 py-3 text-center text-[18px] font-black text-white shadow-md">Open →</div>
    </div>
  </Link>

  <Link href="/revision" className="order-4 group relative h-auto min-h-[420px] overflow-hidden rounded-[32px] border-2 border-[#67c9a5] bg-[#eafbf4] shadow-lg transition hover:-translate-y-1 hover:shadow-2xl xl:col-start-2 xl:row-start-2 md:h-[clamp(410px,calc(100dvh-230px),500px)] md:min-h-0">
    <div className="absolute inset-x-0 top-0 h-[46%] overflow-hidden rounded-t-[30px] bg-[#a6dcf6]"><img src="/dashboard-assets/dashboard-revision.webp" alt="Boy studying for revision" className="block h-full w-full object-cover object-center" /></div>
    <div className="absolute left-6 right-6 top-[43%] bottom-0 rounded-t-[70px] bg-[#f4fffa] px-2 pt-6 sm:pt-7">
      <h2 className="text-[34px] font-black leading-none text-[#183b68]">Revision</h2>
      <p className="mt-3 text-[16px] font-bold text-[#55708b]">Review mistakes and try again</p>
      <div className="absolute bottom-4 left-2 right-2 rounded-full bg-[#35ad82] px-5 py-3 text-center text-[18px] font-black text-white shadow-md">Revise →</div>
    </div>
  </Link>

  <Link href="/peer-challenge" className="order-5 group relative h-auto min-h-[420px] overflow-hidden rounded-[32px] border-2 border-[#ffab8d] bg-[#fff0e9] shadow-lg transition hover:-translate-y-1 hover:shadow-2xl xl:col-start-3 xl:row-start-1 md:h-[clamp(410px,calc(100dvh-230px),500px)] md:min-h-0">
    <div className="absolute inset-x-0 top-0 h-[46%] overflow-hidden rounded-t-[30px] bg-[#ff855f]"><img src="/dashboard-assets/dashboard-buddy-challenge.webp" onError={(event) => { event.currentTarget.onerror = null; event.currentTarget.src = "/dashboard-assets/dashboard-peer.svg"; }} alt="Two young learners enjoying a friendly maths challenge" className="block h-full w-full object-cover object-center" /></div>
    <div className="absolute left-6 right-6 top-[43%] bottom-0 rounded-t-[70px] bg-[#fff3ef] px-2 pt-6 sm:pt-7">
      <h2 className="text-[30px] font-black leading-none sm:text-[34px]">Buddy Challenge</h2>
      <p className="mt-3 text-[16px] font-bold text-[#55708b]">Challenge a friend</p>
      <div className="absolute bottom-4 left-2 right-2 rounded-full bg-[#ff6035] px-5 py-3 text-center text-[18px] font-black text-white shadow-md">Play →</div>
    </div>
  </Link>
</div></div></section></div>}
