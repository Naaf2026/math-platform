...
export default function DashboardPage() {
  ...
  <button type="button" onClick={() => { if (dailyChallengeLimit !== null && dailyChallengeUsed >= dailyChallengeLimit) setShowDailyChallengeLimit(true); else window.location.href = "/challenge"; }} className="order-1 group relative h-auto min-h-[320px] overflow-hidden rounded-[32px] border-2 border-[#ffbd28] bg-[#fff3cc] text-left shadow-lg transition hover:-translate-y-1 hover:shadow-2xl md:h-[clamp(320px,calc(100dvh-340px),360px)] md:min-h-0">
    <div className="absolute inset-x-0 top-0 h-[40%] overflow-hidden rounded-t-[30px] bg-[#ffd45c]"><img src="/dashboard-assets/dashboard-daily.svg" alt="Daily Challenge" className="block h-full w-full object-cover" /></div>
  ...
  <button type="button" onClick={() => { if (isPremium) setShowVisualStart(true); else setShowVisualPremium(true); }} className="order-2 group relative h-auto min-h-[320px] overflow-hidden rounded-[32px] border-2 border-[#9b8cff] bg-[#f0edff] text-left shadow-lg transition hover:-translate-y-1 hover:shadow-2xl md:h-[clamp(320px,calc(100dvh-340px),360px)] md:min-h-0">
    <div className="absolute inset-x-0 top-0 h-[40%] overflow-hidden rounded-t-[30px] bg-gradient-to-br from-[#8d7cf6] to-[#6fc9ff]">
    ...
    <div className="absolute left-4 right-4 top-[37%] bottom-0 rounded-t-[48px] bg-white px-2 pt-4">
  ...
  <Link href="/homework" className="order-3 group relative h-auto min-h-[320px] overflow-hidden rounded-[32px] border-2 border-[#66b8f2] bg-[#e7f5ff] text-left shadow-lg transition hover:-translate-y-1 hover:shadow-2xl md:h-[clamp(320px,calc(100dvh-340px),360px)] md:min-h-0">
    <div className="absolute inset-x-0 top-0 flex h-[40%] items-center justify-center overflow-hidden rounded-t-[30px] bg-gradient-to-br from-[#9ad8ff] via-[#c3eaff] to-[#e2f6ff]" aria-hidden="true">
  ...
  <Link href="/revision" className="order-4 group relative h-auto min-h-[320px] overflow-hidden rounded-[32px] border-2 border-[#67c9a5] bg-[#eafbf4] shadow-lg transition hover:-translate-y-1 hover:shadow-2xl md:h-[clamp(320px,calc(100dvh-340px),360px)] md:min-h-0">
    <div className="absolute inset-x-0 top-0 h-[40%] overflow-hidden rounded-t-[30px] bg-[#a6dcf6]"><img src="/dashboard-assets/dashboard-revision.webp" alt="Boy studying for revision" className="block h-full w-full object-cover object-center" /></div>
  ...
  <Link href="/peer-challenge" className="order-5 group relative h-auto min-h-[320px] overflow-hidden rounded-[32px] border-2 border-[#ffab8d] bg-[#fff0e9] shadow-lg transition hover:-translate-y-1 hover:shadow-2xl md:h-[clamp(320px,calc(100dvh-340px),360px)] md:min-h-0">
    <div className="absolute inset-x-0 top-0 h-[40%] overflow-hidden rounded-t-[30px] bg-[#ff855f]"><img src="/dashboard-assets/dashboard-buddy-challenge.webp" onError={(event) => { event.currentTarget.onerror = null; event.currentTarget.src = "/dashboard-assets/dashboard-peer.svg"; }} alt="Two young learners enjoying a friendly maths challenge" className="block h-full w-full object-cover object-center" /></div>
