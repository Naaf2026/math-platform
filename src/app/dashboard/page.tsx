...
export default function DashboardPage() {
  ...
  <div className="order-2 group relative min-h-[500px] overflow-hidden rounded-[32px] border-2 border-[#9b8cff] bg-[#f0edff] shadow-lg transition hover:-translate-y-1 hover:shadow-2xl md:col-start-1 md:row-start-2 md:min-h-[500px]">
    <div className="absolute inset-x-0 top-0 h-[190px] overflow-hidden rounded-t-[30px] bg-gradient-to-br from-[#8d7cf6] via-[#a994ff] to-[#6fc9ff]">
      <div className="relative flex h-full items-center justify-center gap-3 px-3 sm:gap-4 sm:px-4">
        <div className="grid h-16 w-16 shrink-0 place-items-center rounded-3xl bg-white text-3xl shadow-xl sm:h-20 sm:w-20 sm:text-4xl">👀</div>
        <div className="rounded-2xl bg-white/90 px-3 py-3 text-center shadow-lg sm:px-5">
    ...
    <div className="absolute left-8 right-8 top-[172px] bottom-0 rounded-t-[55px] bg-white px-6 pb-6 pt-8 sm:px-8 sm:pt-9">
      <div className="flex items-start justify-between gap-3">
        <h2 className="min-w-0 pr-1 text-[32px] font-black leading-[0.98] text-[#183b68] sm:text-[40px]">Visual<br className="sm:hidden" /> Questions</h2>
      ...
      <p className="mt-4 max-w-[28rem] pr-1 text-[16px] font-bold leading-6 text-[#6685a4] sm:text-[17px] sm:leading-7">Learn maths by seeing, exploring and solving.</p>
      <button type="button" onClick={() => { if (isPremium) window.location.href = "/visual-questions"; else setShowVisualPremium(true); }} className="absolute bottom-5 left-6 right-6 rounded-full bg-[#735fe6] px-6 py-3.5 text-center text-[20px] font-black text-white shadow-md transition hover:bg-[#634ed5] sm:left-8 sm:right-8">Start →</button>
    </div>
  </div>
