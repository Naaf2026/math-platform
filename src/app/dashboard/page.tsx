...
export default function DashboardPage() {
  ...
  return <main className="min-h-screen bg-[#f7f9fc]">
    ...
    <div className="mx-auto max-w-7xl px-5 py-8 lg:px-8">
      ...
      <section className="mt-8"><div className="flex items-end justify-between"><div><p className="text-sm font-bold uppercase tracking-[0.15em] text-[#0d666b]">Your pathway</p><h2 className="mt-1 text-2xl font-black text-[#071b3a]">Choose a topic</h2></div><Link href="/learn" className="inline-flex items-center gap-1 text-sm font-black text-[#0d666b]">View learning path <ArrowRight size={15}/></Link></div><div className="mt-5 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm"><p className="text-sm leading-6 text-slate-500">Your personalised maths pathway is ready. Start with Foundation topics and build towards Development.</p><Link href="/learn" className="mt-5 inline-flex items-center gap-2 rounded-xl bg-[#0d666b] px-5 py-3 font-bold text-white">Continue learning <ArrowRight size={17}/></Link></div></section>
    </div>
  </main>;
}
