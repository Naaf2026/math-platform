    ...
    <main className="min-h-screen overflow-x-hidden bg-[#eef9ff] text-[#083d78]">
      ...
      <div className="mx-auto flex min-h-[calc(100vh-90px)] max-w-[1680px]">
        <aside className="hidden w-[245px] shrink-0 border-r border-[#dcecf6] bg-[#f5fbff] px-7 py-9 lg:block">
          ...
          <div className="mt-9 border-t border-[#dcecf6] pt-8"><div className="flex items-center gap-4 py-4"><span className="text-4xl">🔥</span><p className="text-[22px] font-black">{profile?.current_streak ?? 0} Day Streak</p></div><div className="flex items-center gap-4 py-4"><span className="text-4xl">⭐</span><p className="text-[22px] font-black">{profile?.xp ?? 0} XP</p></div><div className="flex items-center gap-4 py-4"><span className="text-4xl">🏅</span><p className="text-[22px] font-black">12 Badges</p></div></div>
        </aside>
