...
export default function DashboardPage() {
  ...
  <Link href="/peer-challenge" className="order-5 group relative h-auto min-h-[500px] overflow-hidden rounded-[32px] border-2 border-[#ffab8d] bg-[#fff0e9] shadow-lg transition hover:-translate-y-1 hover:shadow-2xl md:col-start-3 md:row-start-1 md:h-[500px] md:min-h-0">
