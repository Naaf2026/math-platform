...
export default function DashboardPage() {
  ...
  <Link href="/homework" className="order-3 group relative h-auto min-h-[500px] overflow-hidden rounded-[32px] border-2 border-[#66b8f2] bg-[#e7f5ff] text-left shadow-lg transition hover:-translate-y-1 hover:shadow-2xl xl:col-start-2 xl:row-start-1 md:h-[500px] md:min-h-0">
    <div className="absolute inset-x-0 top-0 flex h-[250px] items-center justify-center overflow-hidden rounded-t-[30px] bg-gradient-to-br from-[#9ad8ff] via-[#c3eaff] to-[#e2f6ff]" aria-hidden="true">
      ...
      <span className="relative text-[130px] drop-shadow-xl transition duration-300 group-hover:scale-105">📚</span>
    </div>
    <div className="absolute bottom-0 left-8 right-8 top-[232px] rounded-t-[70px] bg-[#f5fbff] px-2 pt-7 sm:pt-8">
      <h2 className="text-[34px] font-black leading-[0.95] text-[#183b68] sm:text-[38px]">My<br />Homework</h2>
      <p className="mt-4 text-[17px] font-bold text-[#55708b]">Your maths homework and practice worksheets</p>
      <div className="absolute bottom-5 left-2 right-2 rounded-full bg-[#197fe9] px-6 py-3.5 text-center text-[21px] font-black text-white shadow-md">Open →</div>
    </div>
  </Link>

  <Link href="/revision" className="order-4 group relative h-auto min-h-[500px] overflow-hidden rounded-[32px] border-2 border-[#67c9a5] bg-[#eafbf4] shadow-lg transition hover:-translate-y-1 hover:shadow-2xl xl:col-start-2 xl:row-start-2 md:h-[500px] md:min-h-0">
    ...
    <div className="absolute left-8 right-8 top-[232px] bottom-0 rounded-t-[70px] bg-[#f4fffa] px-2 pt-7 sm:pt-8">
      ...
      <div className="absolute bottom-5 left-2 right-2 rounded-full bg-[#35ad82] px-6 py-3.5 text-center text-[21px] font-black text-white shadow-md">Revise →</div>
    </div>
  </Link>
