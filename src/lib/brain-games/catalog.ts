...
const names:Record<BrainGameCategoryKey,string[]> = {
 ...
 speed:["Rocket Addition","Submarine Subtraction","Banana Bonds","Pizza Doubles","Penguin Halves","Cloud Count","Balloon Order","Comet Countdown","Frog Skip","Train Tens","Robot Compare","Odd Treasure","Even Bees","Colour Dash","Shape Safari","Star Twins","Fruit Memory","Drum Beats","Firefly Flash","Pattern Pop","Missing Carriage","Rainbow Sort","Coin Catcher","Clock Sprint","Fraction Feast","Monster Measure","Domino Dash","Bridge Builder","Arrow Adventure","Meteor Mix"],
