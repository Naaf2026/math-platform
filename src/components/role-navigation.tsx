...
export default function RoleNavigation(){
 ...
 if(pathname==="/worksheets"||pathname.startsWith("/worksheets/")||pathname==="/"||pathname==="/parents"||pathname.startsWith("/parents/")||pathname==="/login"||pathname.startsWith("/login/")||pathname==="/register"||pathname.startsWith("/register/")||pathname.startsWith("/subscription")||pathname.startsWith("/pricing")||pathname.startsWith("/about")||pathname.startsWith("/privacy")||pathname.startsWith("/terms")||pathname.startsWith("/payment-policy"))return null;
