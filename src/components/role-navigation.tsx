...
export default function RoleNavigation() {
  ...
  if (pathname === "/login" || pathname.startsWith("/login/") || pathname === "/" || pathname === "/dashboard" || pathname.startsWith("/challenge") || pathname.startsWith("/number-town") || pathname.startsWith("/brain-games") || pathname.startsWith("/visual-questions") || pathname.startsWith("/revision")) return null;
