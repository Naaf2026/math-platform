...
export default function RoleNavigation(){
 ...
 if(pathname==="/"||pathname==="/parents"||pathname.startsWith("/parents/")||pathname==="/login"||pathname.startsWith("/login/")||pathname.startsWith("/subscription")||pathname.startsWith("/about")||pathname.startsWith("/privacy")||pathname.startsWith("/terms")||pathname.startsWith("/payment-policy"))return null;
