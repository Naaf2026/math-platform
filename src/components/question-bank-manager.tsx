...
export default function QuestionBankManager() {
  ...
  return <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-violet-50 p-5 pb-24 sm:p-8"><div className="mx-auto max-w-7xl">
    <header className="flex flex-wrap items-center justify-between gap-4"><div><Link href="/teacher" className="text-sm font-black text-violet-600">← Teacher Dashboard</Link><h1 className="mt-2 flex items-center gap-3 text-3xl font-black text-[#071b3a]"><LibraryBig className="text-violet-600"/> Question Bank</h1><p className="mt-1 text-sm text-slate-500">Create, validate, preview, publish, version and assign interactive maths questions.</p></div><button onClick={create} className="inline-flex items-center gap-2 rounded-2xl bg-violet-600 px-5 py-3 font-black text-white shadow-lg"><Plus size={18}/> New question</button></header>
