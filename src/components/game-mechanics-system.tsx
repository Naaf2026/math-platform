...
export default function GameMechanicsSystem() {
  ...
  useEffect(() => {
    if (!window.location.pathname.startsWith("/mission")) return;
    if (seconds <= 0) { setTimedOut(true); return; }
  ...
  return <>
    <div className="fixed left-1/2 top-20 z-[70] flex -translate-x-1/2 flex-wrap items-center justify-center gap-2 px-3 sm:top-24">
